...
if __name__ == '__main__': 
    ...
    for batch in tqdm(valid_dataloader):
        ...
        # get most probable class for each image in batch
        yhat = torch.argmax(output, dim=1) # returns the indices of the maximum value of all elements along dim=1 (row)
        # print("yhat: ",yhat)

        # get label
        y_label = batch['annotation']

        # add entry to confusion matrix
        confusion_matrix[yhat, y_label] += 1
